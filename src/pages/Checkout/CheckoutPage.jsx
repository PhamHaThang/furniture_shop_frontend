...
const CheckoutPage = () => {
    ...
    const [contentBank] = useState(generateBankTransferContent());
    useEffect(() => {
        if (!isAuthenticated) {
    ...
    const shippingFee =
        totalAmount >= FREE_SHIPPING_THRESHOLD ? 0 : SHIPPING_FEE;
    ...
    const validateStep1 = () => {
        ...
        if (!selectedAddress && !useNewAddress) {
            toast.error(
                "Vui lòng chọn địa chỉ giao hàng hoặc nhập địa chỉ mới",
            );
            return false;
        }
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const orderData = {
                ...
                transactionId:
                    formData.paymentMethod === "BANK" ? transactionId : null,
            };
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div className="lg:col-span-2">
                    ...
                    {step === 1 &&
                        (loadingAddresses ? (
                            <div className="bg-white rounded-xl border border-beige-200 p-8 flex items-center justify-center gap-3 text-char-600">
                                <Spinner size="sm" />
