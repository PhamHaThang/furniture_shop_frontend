    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const personalized = (personalizedRes?.recommendations || [])
                ...
                console.log("Personalized products:", personalized);
            } catch (error) {
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-2xl">
                        ...
                        <p className="text-lg text-beige-100 mb-8 drop-shadow">
                            Khám phá bộ sưu tập nội thất cao cấp với thiết kế
                            tinh tế, chất lượng vượt trội và giá cả hợp lý.
                        </p>
                ...
                <div className="relative rounded-2xl p-8 lg:p-16 text-center text-white overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-beige-50 mb-8 max-w-2xl mx-auto drop-shadow">
                            Ưu đãi đặc biệt cho bộ sưu tập nội thất phòng khách.
