...
export const adminService = {
    ...
    getDashboardStats: async () => {
        const [usersRes, productsRes, ordersRes, orderStatsRes] =
            await Promise.all([
    ...
    // ========== ML ANALYTICS ==========
    getMLSentiment: () => api.get("/admin/ml/sentiment"),
    getMLClusters: (params) => api.get("/admin/ml/clusters", { params }),
    getMLDashboard: (params) => api.get("/admin/ml/dashboard", { params }),
};
